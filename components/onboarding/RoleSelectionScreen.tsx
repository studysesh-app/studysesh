        ...
        <View style={styles.content}>
          ...
          >
            <View style={styles.cardContent}>
              ...
              <View style={styles.textContainer}>
                ...
                <Text style={styles.cardDescription}>Connect with classmates and find tutors</Text>
              </View>
            </View>
          </AnimatedCard>
          ...
          >
            <View style={styles.cardContent}>
              ...
              {/* Text Content */}
              <View style={styles.textContainer}>
                <Text style={styles.cardTitle}>I'm a Student + Tutor</Text>
                <Text style={styles.cardDescription}>All student features, plus earn by tutoring</Text>
              </View>
            </View>
          </AnimatedCard>
          ...
          <Text style={styles.footerText}>
            You can become a tutor later in settings
          </Text>
        </View>
      </View>
    </RippleBackground>
