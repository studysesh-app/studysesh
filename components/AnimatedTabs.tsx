...
export function AnimatedTabs({
    ...
    const getContainerStyles = () => {
        if (variant === 'pill') {
            return 'bg-gray-100 dark:bg-gray-800 rounded-xl flex-row relative';
        }
        return 'border-b border-gray-200 dark:border-gray-700 flex-row relative';
    };
    ...
    const getTextStyles = (isActive: boolean, disabled: boolean) => {
        ...
        if (variant === 'pill') {
            return `${base} ${weight} ${isActive ? 'text-white' : 'text-gray-500 dark:text-gray-400'}`;
        }
