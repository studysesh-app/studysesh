...
const SAMPLE_TUTORS = [
    { name: 'Alex Chen', courses: ['ECOR 1031', 'ECOR 1032'], pronouns: 'they/them', groupPrice: '5', individualPrice: '20', location: ['online', 'Campus'], nextAvailable: 'Tomorrow 2pm' },
    { name: 'Sarah Johnson', courses: ['PHYS 2202', 'CHEM 2103'], pronouns: 'she/her', groupPrice: '3', individualPrice: null, location: ['online'], nextAvailable: '3:30 PM' },
    { name: 'Jaylen Davis', courses: ['MATH 1104', 'MATH 1004'], pronouns: 'he/him', groupPrice: null, individualPrice: '25', location: ['online', 'Campus'], nextAvailable: '1:00 PM' },
    { name: 'Emma Liu', courses: ['COMP 1805', 'COMP 2804'], pronouns: 'she/her', groupPrice: '6', individualPrice: '15', location: ['online'], nextAvailable: 'Wednesday 4pm' },
    { name: 'Jordan Lee', courses: ['SYSC 2006', 'SYSC 2310'], pronouns: 'they/them', groupPrice: '5', individualPrice: null, location: ['online'], nextAvailable: '5:00 PM' },
    { name: 'Riya Jain', courses: ['BUSI 1005', 'STAT 2601'], pronouns: 'he/him', groupPrice: '7', individualPrice: '22', location: ['Campus'], nextAvailable: 'Tomorrow 10am' },
    { name: 'Mahad Qureshi', courses: ['ECON 1001', 'ECON 1002'], pronouns: 'she/her', groupPrice: null, individualPrice: '18', location: ['online', 'Campus'], nextAvailable: '3:00 PM' },
    { name: 'Casey Flanders', courses: ['COMP 1405', 'COMP 1406'], pronouns: 'they/them', groupPrice: '8', individualPrice: '24', location: ['Campus'], nextAvailable: '4:30 PM' },
];
            ...
            <Animated.View style={animatedStyle} collapsable={false}>
                <View style={{ width: BASE_CARD_WIDTH }}>
                    <TutorCard
                        ...
                        nextAvailable={card.tutorData.nextAvailable}
                    />
                </View>
            </Animated.View>
        </GestureDetector>
