...
export function ChatInput({ onSend, placeholder = 'Type a message...' }: ChatInputProps) {
    ...
    return (
        <View
            className="bg-white dark:bg-gray-900 px-4 pt-2"
            style={{ paddingBottom: 8 }}
        >
            <View className="flex-row items-center gap-3">
                <View className="flex-1 flex-row items-center bg-[#f2f2f7] dark:bg-gray-800 rounded-[20px] px-4 min-h-[38px]">
                    <TextInput
                        value={message}
                        ...
                        multiline
                        className="flex-1 text-[17px] text-black dark:text-white max-h-32 py-2"
                        style={{ lineHeight: 22 }}
                    />
                </View>
                ...
                >
                    {message.trim() ? (
                        ...
                        <View className="absolute w-full h-full bg-gray-200 dark:bg-gray-800" />
                    )}
